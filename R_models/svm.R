...
colnames(train)
train <- subset(train, select=-c(3,5,6,9,12,17,18,20,24,31))
test <- subset(test, select=-c(3,5,6,9,12,17,18,20,24,31))
...
library(e1071)
svmfit=svm(train.y, train.X, kernel="linear", cost=10, scale=FALSE)
plot(svmfit, train)
svmfit$index
summary(svmfit)
