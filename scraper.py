...
if __name__ == "__main__":
    make_database('MLB_2015', seasons=[2015])
    make_database('MLB_2016', seasons=[2016])
    make_database('MLB_2017', seasons=[2017])
    make_database('MLB_2018', seasons=[2018])
    make_database('MLB_2019', seasons=[2019])
    make_database('MLB_2020', seasons=[2020])
